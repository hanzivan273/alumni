    ...
    <div class="container">
      ...
      <ul class="navbar-nav ml-auto my-2 my-lg-0">
        ...
        <?php if (isset($_SESSION['login_id'])) : ?>
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=careers">Career Opportunity</a></li>
          <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=forum">Forum & Topics</a></li>
        <?php endif; ?>
